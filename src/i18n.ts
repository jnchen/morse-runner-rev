...
export const resources = {
  ...
  ja: { translation: {
    ...
    settings: '設定', language: '言語', save: 'QSO保存 (Enter)', emptyLog: 'QSOなし', exportLog: 'エクスポート', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: 'トレーニング履歴', contestExchange: 'コンテスト交換', sendExchange: '交換', sendTuAndSave: 'TU+保存', abort: '中止', restore: '復元', noTrainingResults: '保存されたローカル結果はありません', messages: 'メッセージ', invalidMaster: 'MASTER.DTA が無効です', pwaOfflineReady: 'オフラインモードの準備ができました', qsoDetails: 'QSO詳細', youCopied: 'コピーした内容', correctAnswer: '正解', replayCorrectAnswer: '正解を再生', stopReplay: '再生を停止', noCorrectAnswer: 'この NIL 記録には照合可能な相手局データがなく、正解を表示できません。', correctEntry: '検証済み', errorNil: '完了した照合可能な相手局が見つかりません。', errorDuplicate: 'このコールサインは既に検証済み QSO として記録されています。', errorRst: 'コピーした RST が誤っています。', errorNr: 'コピーしたナンバーが誤っています。', errorExchange1: '第1交換項目が誤っています。', errorExchange2: '第2交換項目が誤っています。', pwaUpdateReady: '新しいバージョンがあります', pwaReload: '再読み込み', pwaLater: '後で', pwaClose: '閉じる', time: '時間', rate: 'レート', sendCq: 'CQ', sendNr: 'NR', sendTu: 'TU', sendMyCall: '自分のコール', sendHisCall: '相手のコール', agn: 'AGN', keyboardHint: 'Enter：スマート送信/保存 · Space：次フィールド · Esc：中止 · F1-F9：メッセージ', idle: '待機中',
  }},
} as const;
