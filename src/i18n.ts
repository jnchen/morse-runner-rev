...
export const resources = {
  en: { translation: {
    ...
    settings: 'Settings', language: 'Language', save: 'Save', clear: 'Clear',
    emptyLog: 'No QSO yet', exportLog: 'Export', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: 'Training history', contestExchange: 'Contest exchange', sendExchange: 'EXCH', sendTuAndSave: 'TU+SAVE', abort: 'Abort', restore: 'Restore', noTrainingResults: 'No saved local results', messages: 'Messages', time: 'Time', rate: 'Rate', idle: 'Idle', keyboardHint: 'Enter: smart send/save · Space: next field · Esc: abort · F1-F9: messages', invalidMaster: 'Invalid MASTER.DTA file', pwaOfflineReady: 'Offline mode is ready', pwaUpdateReady: 'A new version is available', pwaReload: 'Reload', pwaLater: 'Later', pwaClose: 'Close', qsoDetails: 'QSO details', youCopied: 'You copied', correctAnswer: 'Correct answer', replayCorrectAnswer: 'Replay correct answer', stopReplay: 'Stop replay', noCorrectAnswer: 'There is no matching station record for this NIL entry, so no correct answer can be shown.', correctEntry: 'Verified', errorNil: 'The callsign does not match the completed station.', errorDuplicate: 'This callsign is already logged as a verified QSO.', errorRst: 'The copied RST is incorrect.', errorNr: 'The copied exchange number is incorrect.', errorExchange1: 'The first exchanged item is incorrect.', errorExchange2: 'The second exchanged item is incorrect.',
  }},
  zh: { translation: {
    title: 'Morse Runner Web',
    ...
    settings: '设置', language: '语言', save: '保存', clear: '清空',
    emptyLog: '暂无 QSO', exportLog: '导出', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: '训练历史', contestExchange: '竞赛交换', sendExchange: '交换', sendTuAndSave: 'TU+保存', abort: '中止', restore: '恢复', noTrainingResults: '暂无本地结果', messages: '报文', time: '时间', rate: '速率', idle: '待机', keyboardHint: 'Enter：智能发送/保存 · Space：下一栏 · Esc：中止 · F1-F9：报文', invalidMaster: 'MASTER.DTA 文件无效', pwaOfflineReady: '离线模式已就绪', pwaUpdateReady: '新版本可用', pwaReload: '重新加载', pwaLater: '稍后', pwaClose: '关闭', qsoDetails: 'QSO 详情', youCopied: '你抄收的内容', correctAnswer: '正确答案', replayCorrectAnswer: '重听正确答案', stopReplay: '停止重听', noCorrectAnswer: '这条 NIL 记录没有可匹配的对方台数据，无法显示正确答案。', correctEntry: '已验证', errorNil: '呼号与已完成通信的对方台不匹配。', errorDuplicate: '该呼号已经有一条验证通过的 QSO。', errorRst: '抄收的 RST 错误。', errorNr: '抄收的序号错误。', errorExchange1: '第一项交换内容错误。', errorExchange2: '第二项交换内容错误。',
  }},
  ja: { translation: {
    ...
    settings: '設定', language: '言語', save: '保存', emptyLog: 'QSOなし', exportLog: 'エクスポート', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: 'トレーニング履歴', contestExchange: 'コンテスト交換', sendExchange: '交換', sendTuAndSave: 'TU+保存', abort: '中止', restore: '復元', noTrainingResults: '保存されたローカル結果はありません', messages: 'メッセージ', invalidMaster: 'MASTER.DTA が無効です', pwaOfflineReady: 'オフラインモードの準備ができました', qsoDetails: 'QSO詳細', youCopied: 'コピーした内容', correctAnswer: '正解', replayCorrectAnswer: '正解を再生', stopReplay: '再生を停止', noCorrectAnswer: 'この NIL 記録には照合可能な相手局データがなく、正解を表示できません。', correctEntry: '検証済み', errorNil: 'コールサインが完了した相手局と一致しません。', errorDuplicate: 'このコールサインは既に検証済み QSO として記録されています。', errorRst: 'コピーした RST が誤っています。', errorNr: 'コピーしたナンバーが誤っています。', errorExchange1: '第1交換項目が誤っています。', errorExchange2: '第2交換項目が誤っています。', pwaUpdateReady: '新しいバージョンがあります', pwaReload: '再読み込み', pwaLater: '後で', pwaClose: '閉じる', time: '時間', rate: 'レート', sendCq: 'CQ', sendNr: 'NR', sendTu: 'TU', sendMyCall: '自分のコール', sendHisCall: '相手のコール', agn: 'AGN', keyboardHint: 'Enter：スマート送信/保存 · Space：次フィールド · Esc：中止 · F1-F9：メッセージ', idle: '待機中',
  }},
} as const;
