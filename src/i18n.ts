...
export const resources = {
  en: { translation: {
    ...
    station: 'Station', band: 'Band', contest: 'Contest',
    ...
    emptyLog: 'No QSO yet', exportLog: 'Export', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: 'Training history', contestExchange: 'Contest exchange', sendExchange: 'EXCH', sendTuAndSave: 'TU+SAVE', abort: 'Abort', restore: 'Restore', noTrainingResults: 'No saved local results', time: 'Time', rate: 'Rate', idle: 'Idle', keyboardHint: 'Enter: smart send/save · Space: next field · Esc: abort · F1-F9: messages', invalidMaster: 'Invalid MASTER.DTA file', pwaOfflineReady: 'Offline mode is ready', pwaUpdateReady: 'A new version is available', pwaReload: 'Reload', pwaLater: 'Later', pwaClose: 'Close',
    pileupCount: "Pile-up", qsoCount: "QSOs", multiplierScore: "Points × multis", startHint: "Choose a training mode to open the band.",
  }},
  zh: { translation: {
    title: 'Morse Runner Web',
    ...
    emptyLog: '暂无 QSO', exportLog: '导出', exportAdif: 'ADIF', exportCabrillo: 'Cabrillo', trainingHistory: '训练历史', contestExchange: '竞赛交换', sendExchange: '交换', sendTuAndSave: 'TU+保存', abort: '中止', restore: '恢复', noTrainingResults: '暂无本地结果', time: '时间', rate: '速率', idle: '待机', keyboardHint: 'Enter：智能发送/保存 · Space：下一栏 · Esc：中止 · F1-F9：报文', invalidMaster: 'MASTER.DTA 文件无效', pwaOfflineReady: '离线模式已就绪', pwaUpdateReady: '新版本可用', pwaReload: '重新加载', pwaLater: '稍后', pwaClose: '关闭',
    pileupCount: "呼叫堆积", qsoCount: "QSO", multiplierScore: "得分 × 多人", startHint: "选择训练模式开台。",
  }},
  ja: { translation: {
    title: 'Morse Runner Web', subtitle: 'モダンなクロスプラットフォームCWコンテストトレーナー',
    start: '開始', stop: '停止', pileup: 'パイルアップ', single: 'シングルコール', wpx: 'WPX', hst: 'HST',
    station: '局', band: 'バンド', contest: 'コンテスト', callsign: 'コールサイン', name: '名前',
