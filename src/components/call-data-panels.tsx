    ...
    <>
      <section className="rounded-lg border border-slate-800 bg-slate-900 p-3 sm:p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button type="button" onClick={() => historyFileRef.current?.click()} className="min-h-11 rounded border border-slate-700 px-3 py-2 text-sm hover:bg-slate-800">{t('importHistory')}</button>
          <button type="button" onClick={onResetCallHistory} className="min-h-11 rounded border border-slate-700 px-3 py-2 text-sm hover:bg-slate-800">{t('resetHistory')}</button>
      ...
      <section className="rounded-lg border border-slate-800 bg-slate-900 p-3 sm:p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button type="button" onClick={() => callFileRef.current?.click()} className="min-h-11 rounded border border-slate-700 px-3 py-2 text-sm hover:bg-slate-800">{t('importMaster')}</button>
          <button type="button" onClick={onResetCallList} className="min-h-11 rounded border border-slate-700 px-3 py-2 text-sm hover:bg-slate-800">{t('resetCalls')}</button>
