...
export function MobileActionBar({
  ...
  return (
    <nav
      ...
      className="shrink-0 border-t border-slate-800 bg-slate-950/95 pb-[calc(env(safe-area-inset-bottom,0px)+0.5rem)] compact-with-keyboard backdrop-blur lg:hidden"
    >
